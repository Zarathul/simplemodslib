...
public record FluidContainerComponent(FluidStack fluid, long capacity, boolean singleBucketMode)
{
	public FluidContainerComponent(FluidStack fluid, long capacity)
	{
	...
	public static final Codec<FluidContainerComponent> CODEC = RecordCodecBuilder.create(instance -> instance.group(
		...
		Codec.LONG.fieldOf("capacity").forGetter(FluidContainerComponent::capacity),
	...
	public static final StreamCodec<RegistryFriendlyByteBuf, FluidContainerComponent> STREAM_CODEC = StreamCodec.composite(
		...
		ByteBufCodecs.LONG, FluidContainerComponent::capacity,
